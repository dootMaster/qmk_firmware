...
// entirely and just use numbers.q
#define _QWERTY 0
#define _FN     1
#define _NUMPAD 2

// Some basic macros
#define TAB_R  LCA(KC_TAB)
#define TAB_L  LCA(LSFT(KC_TAB))
#define SCREEN_GRAB  SGUI(KC_S)
#define MULTI LGUI(KC_X)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x7(
        ...
        KC_LALT,   KC_A,    KC_S,    KC_D,   KC_F,   KC_G,   MO(_FN),
